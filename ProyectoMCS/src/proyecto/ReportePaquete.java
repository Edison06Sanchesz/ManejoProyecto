 ...
 * @author edison
 */
public class ReportePaquete extends javax.swing.JFrame {

    /**
     * Creates new form ReportePaquete
     */
    public ReportePaquete() {
        initComponents();
        cargarTablaPaquetes();
    }
    public void cargarTablaPaquetes() {
        try {
            ...
            String titulos[] = {"CODIGO", "NOMBRE", "APELLIDO", "ARTICULO", "TIPO", "LOCAL","DESTINO","ESTADO","ASIGNACION"};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REPORTE PAQUETES");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportePaquete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportePaquete().setVisible(true);
            }
        });
    }
